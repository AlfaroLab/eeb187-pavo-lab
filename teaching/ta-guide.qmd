...
| `Error: could not find function "simple_coldists"` (or `pick_white_bg`, etc.) | `source("scripts/helpers.R")` skipped | back to Step 0; this is the most common Step 3 error in our test runs |
:::
